...
<template>
  <div
    class="grid grid-cols-3 sm:grid-cols-10 3md:grid-cols-12 text-qwerty-white gap-4 text-sm px-4 py-2 mb-1 items-center border-b"
  ...
  >
    ...
    <div class="sm:hidden flex flex-col items-end font-mono">
      <div class="flex flex-wrap items-center">
        ...
        <div class="w-full text-qwerty-white text-xs">{{ expiryAt }}</div>
      </div>
    </div>
    ...
    >
      ...
      <div class="w-full text-qwerty-white text-xs text-right">
        {{ expiryAt }}
      </div>
    </span>
  </div>
