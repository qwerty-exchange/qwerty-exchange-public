  ...
  <div>
    ...
    >
      ...
      <div class="flex items-center">
        ...
        >
          <template #prefix>
            <span class="text-xs text-qwerty-white uppercase">
              {{ $t('markets.quote') }}
            </span>
          </template>

          <template #default="{ selected }">
            <span v-if="selected" class="text-xs text-qwerty-primary uppercase">
              {{ selected.display }}
            </span>
          </template>

          <template #option="{ option }">
            <span class="text-xs uppercase text-qwerty-white">
              {{ option.display }}
            </span>
          </template>
        </AppSelect>
