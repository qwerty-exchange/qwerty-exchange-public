...
<template>
  <div class="text-qwerty-white sm:mb-[144px] mb-10">
    <div
      class="font-semibold text-2xl sm-text-3xl text-qwerty-white text-left sm:text-center mt-16 sm:mt-[120px] mb-6"
    >
      {{ $t('home.getStarted') }}
    </div>
    <div
