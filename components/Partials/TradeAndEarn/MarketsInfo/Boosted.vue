  ...
  <PartialsCommonStatsItem>
    <div class="flex justify-between text-xs w-full mx-auto">
      <div class="flex-1 px-4 lg:px-6">
        <p class="text-qwerty-white text-center font-semibold">
          {{ $t('trade.derivatives') }}
        </p>
        <CommonTextInfo
          ...
          class="mt-1 text-qwerty-white"
          sm
        >
          <p class="text-qwerty-white font-mono">
            <span>
              {{ derivative.makerPointsMultiplier }}x
              <span class="text-sm text-qwerty-white font-sans">
                {{ $t('maker_points_mul') }}
              </span>
              /
    ...
    <template #title>
      <div class="flex items-center justify-center text-qwerty-white text-xs">
