  ...
  >
    ...
    >
      <BaseIcon
        ...
        class="text-qwerty-white transform rotate-180 mr-2 w-2 h-2"
      />
      <span
        class="block text-right font-mono"
        :class="{
          'text-qwerty-green': recordTypeBuy,
          'text-qwerty-red': !recordTypeBuy
        }"
      >
        <AppNumber
          xs
    ...
    <span class="w-1/3 text-xs px-2 z-[8]" @click.stop="onSizeClick">
      <span
        class="block text-right font-mono"
        :class="{
          'text-qwerty-red': quantityChange === Change.Decrease,
          'text-qwerty-green': quantityChange === Change.Increase
        }"
      >
        <AppNumber
          xs
...
.size-col.green-record-bg {
  @apply visible;
  fill: theme('colors.qwerty.green');
  opacity: 0.35;
...
.depth-col.buys-green-bg {
  background: theme('colors.qwerty.green');
  opacity: 0.2;
}

.depth-col.sells-red-bg {
  background: theme('colors.qwerty.red');
  opacity: 0.2;
}
