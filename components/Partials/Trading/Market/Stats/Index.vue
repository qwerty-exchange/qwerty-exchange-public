  ...
  >
    ...
    >
      ...
      >
        <div class="flex items-center gap-4" @click="handleTokenClick">
          ...
          <div class="leading-none select-none cursor-pointer">
            <p
              class="text-qwerty-white font-semibold text-sm flex items-center"
            >
              <span
              ...
              <BaseIcon
                name="chevron"
                class="w-auto h-3 text-qwerty-white ml-2 transform transition ease-in-out duration-300"
                :class="[expanded ? 'rotate-90' : '-rotate-90']"
              />
            </p>

            <p class="text-qwerty-white text-xs">
      ...
      <div class="ml-auto hidden lg:block">
        <BaseHoverMenu
          popper-class="rounded-lg flex flex-col flex-wrap text-xs absolute w-80 bg-qwerty-shade2 shadow-dropdown z-40"
        >
          <template #default>
            <button
            ...
            >
              <BaseIcon
                name="sliders"
                class="text-qwerty-white group-hover:text-qwerty-primary w-4 h-4"
              />
            </button>
          </template>
