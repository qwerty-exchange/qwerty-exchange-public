...
const wrapperClasses = computed(() => {
  ...
  if (showSlippageError.value) {
    classes.push('border-red-500 bg-qwerty-red')
  }
...
<template>
  <div class="border-t mt-6">
    ...
    >
      <span
        class="block font-semibold text-sm text-qwerty-white flex-1"
      ...
      <div class="flex items-stretch">
        <BaseIcon
          name="caret-down"
          class="text-qwerty-white group-hover:text-qwerty-primary transform rotate-180 self-center w-4 h-4"
    ...
    <div
      ...
      :class="showSlippageWarning ? 'text-orange-500' : 'text-qwerty-red'"
      font-semibold
      text-2xs
    >
