  ...
  <div>
    ...
    <CommonTableHeader classes="flex flex-wrap mb-2 max-3xl:px-0">
      <div class="flex items-center flex-1 text-2xs">
        ...
        >
          <span
            class="text-qwerty-white font-normal order-last whitespace-nowrap"
          >
            {{ $t('trade.market') }} /
          </span>
        </AppSortableHeaderItem>
        ...
        >
          <span class="text-qwerty-white font-normal ml-1">
            {{ $t('trade.volume') }}
          </span>
        </AppSortableHeaderItem>
      </div>
      ...
      >
        <span class="font-normal text-qwerty-white">
          {{ $t('trade.price') }} /
        </span>
        <AppSortableHeaderItem
          v-model:sort-by="sortBy"
          ...
          icon-class="order-last"
        >
          <span class="text-qwerty-white font-normal">
      ...
      <template #empty>
        ...
        >
          ...
          <span
            ...
            class="mt-1 text-2xs text-qwerty-white text-center"
          >
            {{ $t('markets.emptyDescriptionFavorites') }}
          </span>

          <span v-else class="mt-1 text-2xs text-qwerty-white text-center">
