...
<template>
  <div
    class="grid grid-cols-6 md:grid-cols-12 text-qwerty-white gap-4 text-sm px-4 items-center h-14 border-b border-gray-700"
  >
    <div
    ...
    >
      ...
      <span
        class="text-qwerty-white whitespace-nowrap overflow-hidden overflow-ellipsis"
      >
        {{ address }}
      </span>
    </div>
    ...
    <span class="block font-mono text-right col-span-2 md:col-span-2 text-sm">
      <span class="text-qwerty-white overflow-ellipsis whitespace-nowrap">
    ...
    <div class="hidden md:block col-span-2 text-right">
      <a
        :href="explorerUrl"
        target="_blank"
        class="text-qwerty-white cursor-pointer whitespace-nowrap overflow-ellipsis"
      >
