...
<template>
  ...
  >
    <td class="font-mono pl-3">
      <span class="text-qwerty-white text-sm">{{ time }}</span>
    </td>
    ...
    <td class="text-left cursor-pointer">
      <NuxtLink class="flex items-center justify-start" :to="marketRoute">
        ...
        <div class="ml-3">
          <span
            class="text-qwerty-white font-semibold"
    ...
    <td class="text-right font-mono pr-3">
      ...
      >
        <template #addon>
          <span class="text-sm text-qwerty-white">
      ...
      >
        ...
        <span class="text-qwerty-white">{{ market.quoteToken.symbol }}</span>
      </span>
    </td>
  </tr>
</template>
