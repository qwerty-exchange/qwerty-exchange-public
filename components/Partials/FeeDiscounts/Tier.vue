...
<template>
  <tr>
    <td class="h-8 text-left font-mono">
      <div class="flex items-center gap-4">
        <div
          ...
          class="bg-qwerty-primary text-qwerty-background w-2 h-2 ml-2 rounded-full"
        />
    ...
    <td class="h-8 text-right font-mono">
      ...
      <span class="text-2xs text-qwerty-white"> INJ </span>
    </td>
    <td class="h-8 text-right font-mono">
      <span class="text-qwerty-white uppercase text-2xs tracking-wider">
        {{ $t('and') }}
      </span>
    </td>
    <td class="h-8 text-right font-mono">
      &#8805; {{ volumeToFormat }}
      <span class="text-2xs text-qwerty-white"> USD </span>
    </td>
