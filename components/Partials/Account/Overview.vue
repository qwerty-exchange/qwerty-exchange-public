    ...
    >
      ...
      >
        <NuxtLink :to="{ name: 'bridge', query: { type: BridgeType.Deposit } }">
          <AppButton class="bg-qwerty-primary">
        ...
        >
          <AppButton class="border border-qwerty-primary">
            <span class="text-qwerty-primary font-semibold">
              {{ $t('account.withdraw') }}
            </span>
          </AppButton>
        </NuxtLink>
        ...
        <AppButton
          class="border border-qwerty-primary"
