...
<template>
  <tr
    class="border-b border-gray-700 last-of-type:border-b-transparent hover:bg-qwerty-shade3 bg-transparent overflow-hidden gap-2 transition-all"
      ...
      <div class="flex flex-col py-4 pl-4">
        <div class="flex justify-start items-center gap-2">
          ...
          <div class="flex flex-col gap-1">
            <span
              class="text-qwerty-white font-bold tracking-wide text-sm uppercase h-6 flex items-center"
