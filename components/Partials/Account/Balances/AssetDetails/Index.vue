      ...
      >
        ...
        >
          ...
          <div class="mt-auto flex justify-between gap-4">
            ...
            >
              <button
                class="w-full cursor-pointer h-10 flex justify-center items-center rounded-lg bg-transparent border-qwerty-primary border"
              >
                <span class="text-sm font-medium text-qwerty-primary">
                  {{ $t('account.withdraw') }}
                </span>
              </button>
            </NuxtLink>
