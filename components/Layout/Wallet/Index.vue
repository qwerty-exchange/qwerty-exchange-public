...
function handleMobileModalOpen() {
  modalStore.openModal({ type: Modal.Mobile })
}
...
<template>
  <AssetMobileIcon
    v-if="isDev && walletStore.isUserWalletConnected"
    class="w-5 h-5 cursor-pointer text-qwerty-white hover:text-qwerty-primary"
    @click.stop="handleMobileModalOpen"
  />
