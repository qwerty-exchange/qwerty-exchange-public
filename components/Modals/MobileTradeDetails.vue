...
<template>
  <AppModal v-if="trade && market" :show="isModalOpen" sm @modal:closed="close">
    ...
    <div class="bg-qwerty-shade2 px-3 py-4 grid grid-cols-2 gap-4 text-sm">
      <div class="flex items-center">
        <span class="text-qwerty-white uppercase tracking-widest text-2xs">
          {{ $t('trade.time') }}
        </span>
        <CommonInfoTooltip
          class="ml-2"
      ...
      <span
        class="text-qwerty-white uppercase tracking-widest text-xs self-center"
      >
        {{ $t('trade.pair') }}
      </span>
      ...
      <span
        ...
        :class="{
          'text-qwerty-green': trade.tradeDirection === TradeDirection.Buy,
          'text-qwerty-red': trade.tradeDirection === TradeDirection.Sell
        }"
      >
        {{
          $t(
