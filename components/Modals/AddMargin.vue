        ...
        <div class="px-4 w-full">
          <div class="text-center">
            <div class="flex items-center justify-center">
              <p class="uppercase text-xs font-semibold text-qwerty-white">
            ...
            <div class="mt-4 text-center">
              <span
                class="font-mono flex items-center justify-center text-qwerty-white text-base lg:text-xl"
                data-cy="add-margin-modal-available-text-content"
              >
                {{ availableMarginToString }}
                <span class="text-qwerty-white ml-2">{{
            ...
            <div class="flex flex-wrap">
              <div class="w-full">
                ...
                <p
                  ...
                  class="capitalize-phrase text-qwerty-red text-sm mt-2"
                >
                  {{ amountErrors[0] }}
                </p>
              </div>
              <div class="w-full mt-6 text-center">
                <AppButton
                  lg
                  class="w-full bg-qwerty-primary text-qwerty-background"
                  :status="status"
