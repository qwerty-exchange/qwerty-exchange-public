...
<template>
  <div class="relative flex items-center w-full">
    ...
    <div class="px-4">
      <div
        class="bg-qwerty-primary min-w-6 h-6 mx-6 flex items-center justify-center rounded-full"
    ...
    <div class="flex-1">
      ...
      >
        ...
        <template #option="{ option, active }">
          ...
          >
            <span
              class="bg-qwerty-primary mr-2 font-semibold tracking-wide text-xs px-1 py-px rounded-sm"
            >
              {{ t('common.new') }}
            </span>
            {{ option.display }}
