...
<template>
  <BaseModalWrapper
    ...
    wrapper-class="backdrop-filter backdrop-blur qwerty-shade2 bg-opacity-90 max-sm:z-40"
    :show="isModalOpen"
    @close="closeModal"
  >
    <section v-if="market" ref="canvas" class="sm:aspect-[1.91/1] bg-black">
      ...
      >
        ...
        <div class="space-y-6 flex-grow my-8">
          <div class="flex items-center gap-3">
            ...
            <template v-if="showLeverage">
              <span class="border-r w-1 h-4 border-qwerty-primary" />
        ...
        >
          ...
          <div
            class="bg-qwerty-primary text-white font-semibold rounded-full flex items-center justify-center p-2 hover:bg-blue-100 hover:text-qwerty-primary cursor-pointer"
