...
<template>
  <div
    class="flex-col bg-qwerty-background rounded-xl py-4 max-h-24"
    :class="{
      ...
      <div class="px-4">
        <div class="flex justify-between">
          ...
          <div class="flex flex-col gap-2 basis-full">
            <div class="flex justify-end text-qwerty-white">
              <AppSelectTokenItem v-if="balance" :token="balance.token" xl />
            </div>

            <div
              class="text-right flex items-center justify-end gap-2 text-xs font-normal text-qwerty-white"
            >
