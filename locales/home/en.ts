...
export default {
  home: {
    title: 'Qwerty is your Exchange',
    subtitle: 'Buy and sell what and when you want',
    subsubtitle: "It's easy as Qwerty and secure as blockchain",
    tradeNow: 'Trade Now',
    ...
    builtOn: 'Built on',
    startTradingNote: 'Start Trading on Qwerty Now',
    whyTradeOnHelix: 'Why Trade on Qwerty',
  ...
  newsletter: {
    title: 'Subscribe to Qwerty newsletter',
  ...
  footer: {
    ...
    helixProvides:
      '*Note: Qwerty is able to provide maker rebates across a number of markets as approved via the Injective DAO.'
  }
}
