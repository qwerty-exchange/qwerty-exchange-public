...
import { TokenSignClient } from './services/TokenSignClient'
import { MsgQwertyBroadcaster2 } from './services/MsgQwertyBroadcaster2'
import {
  NETWORK,
  CHAIN_ID,
  ENDPOINTS,
...
export const msgBroadcastClient = new TokenSignClient(
  new MsgQwertyBroadcaster2({
    walletStrategy,
    network: NETWORK,
