...
<template>
  <div
    id="pro"
    class="flex min-h-screen max-h-screen bg-qwerty-background text-qwerty-white relative overflow-x-hidden"
  >
      ...
      <div class="min-h-screen w-full">
        <AppHocLoading :status="status" class="h-full">
          <div class="w-full">
            ...
            />
            <client-only>
              <div class="bg-qwerty-background">
                <LayoutTopbar
    ...
    >
      <template #notification="{ notification }">
        <BaseNotification
          ...
          class="pointer-events-auto bg-qwerty-shade2"
        >
          <template #close="{ close }">
            <BaseIcon
              name="close-bold"
              class="min-w-4 hover:text-qwerty-primary text-qwerty-white w-4 h-4"
              @click="close"
            />
          </template>
        </BaseNotification>
